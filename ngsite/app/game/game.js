...
bestbuys.config(['$routeProvider', function ($routeProvider) {
...
bestbuys.controller('GameCtrl', ['$scope', 'Game', 'Command', 'Notification', function ($scope, Game, Command, Notification) {
...
bestbuys.factory('Game', ['$resource', function ($resource) {
  return $resource('/games/:id', {id: '@id'});
}]);

bestbuys.service('Notification', [function () {
...
bestbuys.service('Command', ['$http', function ($http) {
